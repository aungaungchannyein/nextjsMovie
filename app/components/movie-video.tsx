...
export default async function MovieVideo(){
  ...
  return <div className="h-[55vh] lg:h-[60vh] w- full flex justify-start items-center">
    <video poster={data?.imageString}
    autoPlay
    muted
    loop
    src={data?.videoSource}
    className="w-full absolute top-0 left-0 h-[65vh] object-cover -z-10 brightness-[60%]"></video>
